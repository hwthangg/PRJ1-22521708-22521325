...
import styles from "./MemberDocument.module.css";
...
export default function MemberDocument() {
    ...
    const fetchDocuments = async () => {
      try {
        const res = await fetch(
          ...
          }/api/documents?page=${currentPage}&limit=6&search=${search}&scope=chapter`,
          {
  ...
  return (
    <div className={styles.container}>
      ...
      {openDetails && <DocumentDetails id={id} open={setOpenDetails} canEdit = {false}/>}
