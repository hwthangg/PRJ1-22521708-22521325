...
export default function DocumentDetails({ id, open, canEdit }) {
  ...
  useEffect(() => {
    const fetchDocument = async () => {
      if (!id) return;
      try {
        const response = await fetch(`${import.meta.env.VITE_APP_SERVER_URL}/api/documents/${id}`, {
          headers: {
      ...
      <div className={styles.formContainer}>
        <div className={styles.form}>
          ...
          <div className={styles.previewDocument} style={{ width: 440 }}>
            <h2 style={{ color: "var(--dark-blue)" }}>Xem tài liệu PDF</h2>
